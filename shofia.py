...
def wishMe():
    ...
    speak("I am Shofia,Your Personally AI Assistant , Please tell me How may I help You")
def takeCommand():
...
if __name__ == "__main__":
    ...
    while True:
        ...
        # some QnA from shofia
        if " your name" in query:
            name = "my name is shofia and I am 3.11.1 version AI Robots"
            speak(name)
        elif " your age" in query:
            name = "I am 20 years old"
            speak(name)
        elif "who are you" in query:
                speak("I am your virtual assistant created by Shayla")
            ...
            speak(results)
                ...
                speak("I have been created by Shayla Mam.")
        ...
        elif "will you be my gf" in query in query:  
            speak("I'm not sure about, may be you should give me some time")
        elif 'date' in query:
                speak('sorry, I have a headache')
        elif 'love you' in query:
            speak('Tauba, Tauba sara mood kharab kar diya')
        ...
        # playlist of fav songs
            ...
            b= random.choice(a)
            if b==1:
                webbrowser.open("https://youtu.be/I94fhjQ-U30")
            elif b==2:
                webbrowser.open("https://youtu.be/lbCRtrrMvSw")
            elif b==3:
                webbrowser.open("https://youtu.be/QCXaa1mEUK0")
            elif b==3:
